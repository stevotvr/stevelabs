      ...
      db.serialize(() => {
        db.run('CREATE TABLE IF NOT EXISTS settings (key TEXT PRIMARY KEY, value TEXT)')
          .all('SELECT key, value FROM settings', (err, rows) => {
            ...
            db.run('CREATE TABLE IF NOT EXISTS giveaway (id INTEGER PRIMARY KEY AUTOINCREMENT, groupId INTEGER NOT NULL, name TEXT NOT NULL, key TEXT NOT NULL, recipient INTEGER)');
            ...
            db.run('CREATE TABLE IF NOT EXISTS quotes (id INTEGER PRIMARY KEY AUTOINCREMENT, date INTEGER NOT NULL, user INTEGER, game TEXT NOT NULL, message TEXT NOT NULL)');
            ...
            db.run('CREATE TABLE IF NOT EXISTS tips (id INTEGER PRIMARY KEY AUTOINCREMENT, date INTEGER NOT NULL, user INTEGER, message TEXT NOT NULL)');
            ...
            db.run('CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY AUTOINCREMENT, userId INTEGER NOT NULL UNIQUE, userName TEXT NOT NULL UNIQUE, displayName TEXT NOT NULL, chats INTEGER NOT NULL DEFAULT 0, trivia INTEGER NOT NULL DEFAULT 0, raffle INTEGER NOT NULL DEFAULT 0, ignoreStats INTEGER NOT NULL DEFAULT 0, autoGreet INTEGER NOT NULL DEFAULT 0)');
